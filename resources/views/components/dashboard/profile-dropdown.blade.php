...
<div class="relative" data-profile-menu>
    <button class="flex items-center gap-2 rounded-2xl p-1.5 transition hover:bg-slate-100" type="button" data-profile-button aria-haspopup="true" aria-expanded="false">
        <span class="grid h-9 w-9 place-items-center rounded-2xl bg-courtigo-navy text-xs font-black text-white">{{ $initials ?: 'U' }}</span>
        <svg class="hidden h-4 w-4 text-slate-500 sm:block" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" /></svg>
    </button>
