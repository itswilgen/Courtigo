<header class="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur">
    <div class="flex h-16 items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3">
            <button class="grid h-10 w-10 place-items-center rounded-2xl border border-slate-200 text-courtigo-navy shadow-sm lg:hidden" type="button" data-sidebar-open aria-label="Open menu">
        ...
        <div class="flex items-center gap-2">
            <button class="relative grid h-10 w-10 place-items-center rounded-2xl text-slate-600 transition hover:bg-slate-100 hover:text-courtigo-navy" type="button" aria-label="Notifications">
